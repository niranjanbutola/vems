...
<%
	...
	String heading="Un-Assign Project";
	...
	try
	{
		...
		data+="<form role=\"form\" action=unAssignProjectAction.jsp method=post>";
		...
		data+="<input type=\"submit\" class=\"btn btn-primary\" value=\"Un-Assign Project\"></input>";
		data+="</form>";
